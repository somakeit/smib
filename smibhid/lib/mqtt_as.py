...
class MQTT_base:
    ...
    def __init__(self, config):
        ...
        self._sock = None
        self._sta_if = network.WLAN(network.STA_IF) # TODO See if this should be removed or adjusted
...
class MQTTClient(MQTT_base):
    ...
    async def connect(self, *, quick=False):  # Quick initial connect option for battery apps # TODO add option to disable wifi management if externally managed
    ...
    async def _keep_connected(self): # TODO fix this not being called if external wifi handler
